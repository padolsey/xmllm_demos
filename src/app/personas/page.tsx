        ...
        <div className="absolute inset-0 flex items-center justify-center bg-background">
          <div className="w-full max-w-2xl p-8 space-y-6">
            ...
            <button
              ...
              className="w-full px-8 py-3 bg-primary text-primary-foreground rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:scale-105 active:scale-95 shadow-lg"
            >
      ...
      {!showInput && (
        <div className="p-8">
          ...
          <button
            ...
            className="fixed bottom-4 right-4 px-4 py-2 bg-primary/90 text-primary-foreground rounded-xl z-20 hover:bg-primary transition-all duration-200 hover:scale-105 active:scale-95 shadow-lg backdrop-blur-sm"
          >
